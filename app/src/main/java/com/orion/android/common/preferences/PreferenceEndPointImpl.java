...
public class PreferenceEndPointImpl implements PreferenceEndPoint {
     ...
     * @see PreferenceEndPoint#saveBooleanPreference(String, boolean)
     */
     ...
     * @param key   the key
     * @param value the value
     * @see PreferenceEndPoint#saveIntPreference(String, int)
     */
    @SuppressLint("CommitPrefEdits")
    @Override
     ...
     * @param key   the key
     * @param value the value
     * @see PreferenceEndPoint#saveLongPreference(String, long)
     */
    @SuppressLint("CommitPrefEdits")
    @Override
     ...
     * @param key   the key
     * @param value the value
     * @see PreferenceEndPoint#saveStringPreference(String, String)
     */
    @SuppressLint("CommitPrefEdits")
    @Override
     ...
     * @see PreferenceEndPoint#getBooleanPreference(String)
     */
    @Override
     ...
     * @return the boolean preference
     * @see PreferenceEndPoint#getBooleanPreference(String, boolean)
     */
    @Override
     ...
     * @see PreferenceEndPoint#getIntPreference(String)
     */
    @Override
     ...
     * @param defValue the def value
     * @return the int preference
     * @see PreferenceEndPoint#getIntPreference(String, int)
     */
    @Override
     ...
     * @see PreferenceEndPoint#getLongPreference(String, long)
     */
    @Override
     ...
     * @see PreferenceEndPoint#getStringPreference(String)
     */
    @Override
     ...
     * @param defValue the def value
     * @return the string preference
     * @see PreferenceEndPoint#getStringPreference(String, String)
     */
    @Override
