...
public class YoChatMessageBox  extends RelativeLayout {
    ...
    public YoChatMessageBox(Context context) {
        super(context);
    }

    public YoChatMessageBox(Context context, AttributeSet attrs) {
        super(context, attrs);

        a = context.obtainStyledAttributes(attrs, R.styleable.YoChatMessageBox, 0, 0);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        try {
            viewPartMain = (TextView) this.findViewById(a.getResourceId(R.styleable.YoChatMessageBox_viewPartMain, -1));
            viewPartSlave = this.findViewById(a.getResourceId(R.styleable.YoChatMessageBox_viewPartSlave, -1));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
