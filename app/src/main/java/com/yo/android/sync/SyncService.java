...
public class SyncService extends Service {
    ...
    private static YoContactsSyncAdapter sSyncAdapter = null;

    /**
     * Thread-safe constructor, creates static {@link YoContactsSyncAdapter} instance.
     */
    @Override
    public void onCreate() {
        ...
        synchronized (sSyncAdapterLock) {
            if (sSyncAdapter == null) {
                sSyncAdapter = new YoContactsSyncAdapter(getApplicationContext(), true);
            }
        }
    }
    ...
    /**
     * Return Binder handle for IPC communication with {@link YoContactsSyncAdapter}.
     *
     * <p>New sync requests will be sent directly to the SyncAdapter using this channel.
     *
     * @param intent Calling intent
     * @return Binder handle for {@link YoContactsSyncAdapter}
     */
    @Override
