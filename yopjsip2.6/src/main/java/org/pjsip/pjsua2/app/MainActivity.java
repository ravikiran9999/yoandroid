...
public class MainActivity extends Activity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_acc_config) {
            dlgAccountSetting();
...
/* Message not handled */
    ...
    private void dlgAccountSetting() {
        ...
        etReg.setText("sip:173.82.147.172:5060");
        etProxy.setText("sip:173.82.147.172:5060");
...
/* Only one call at anytime */
    ...
    private void dlgAddEditBuddy(BuddyConfig initial) {
        ...
        etUri.setText("sip:64724865@173.82.147.172");
