			  ...
			  implements Handler.Callback, MyAppObserver
{
	...
	if (app.accList.size() == 0) {
	    ...
	    accCfg.setIdUri("sip:603703@173.82.147.172");
	...
	if (creds.size() > 0) {
		...
		etId.setText("sip:64724865@173.82.147.172");//  603703@173.82.147.172
		etReg.setText("sip:173.82.147.172:5061");
		etProxy.setText("sip:173.82.147.172:5061");
		etUser.setText("64724865");
		etPass.setText("823859");//  @pa1ra2di3gm
	...
	String buddy_uri = "sip:603703@173.82.147.172";
	...
	final CheckBox cbSubs = (CheckBox)view.findViewById(R.id.checkBoxSubscribe);
     etUri.setText("sip:603703@173.82.147.172:5061");
	if (is_add) {
