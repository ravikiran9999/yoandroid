...
public class EpConfig extends PersistentObject {
	...
	public void setUaConfig(UaConfig value) {
		pjsua2JNI.EpConfig_uaConfig_set(swigCPtr, this,
				UaConfig.getCPtr(value), value);
	}
	...
	public void setLogConfig(LogConfig value) {
		pjsua2JNI.EpConfig_logConfig_set(swigCPtr, this,
				LogConfig.getCPtr(value), value);
	}
	...
	public void setMedConfig(MediaConfig value) {
		pjsua2JNI.EpConfig_medConfig_set(swigCPtr, this,
				MediaConfig.getCPtr(value), value);
	}
