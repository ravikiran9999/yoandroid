...
//            configAccount("sip:9701449817@209.239.120.239",
...
//        buddyListAdapter = new SimpleAdapter(this, buddyList,
...
//        final EditText etReg = (EditText) view
//                .findViewById(R.id.editTextRegistrar);
//        final EditText etProxy = (EditText) view
//                .findViewById(R.id.editTextProxy);
//        final EditText etUser = (EditText) view
...
//
//                configAccount(acc_id, registrar, proxy, username, password);
//
//				/* Finally */
//                lastRegStatus = "";
//                try {
...
//    }
//
//    private void configAccount(String acc_id, String registrar, String proxy,
