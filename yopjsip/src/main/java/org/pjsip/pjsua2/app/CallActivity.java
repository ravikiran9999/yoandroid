...
//
//		SurfaceView surfaceInVideo = (SurfaceView) findViewById(R.id.surfaceIncomingVideo);
//		SurfaceView surfacePreview = (SurfaceView) findViewById(R.id.surfacePreviewCapture);
...
//				MyApp.ep.vidDevManager()
//						.setCaptureOrient(cap_dev, orient, true);
//			} catch (Exception e) {
//				System.out.println(e);
//			}
//		}
...
//				/*
//				 * Set capture orientation according to current device
//				 * orientation.
//				 */
