...
public class Endpoint {
	...
	public pjsua_state libGetState() {
		return pjsua_state.swigToEnum(pjsua2JNI.Endpoint_libGetState(swigCPtr,
				this));
	}

	public void libInit(EpConfig prmEpConfig) throws Exception {
		pjsua2JNI.Endpoint_libInit(swigCPtr, this,
				EpConfig.getCPtr(prmEpConfig), prmEpConfig);
	}
	...
	public void utilLogWrite(int prmLevel, String prmSender, String prmMsg) {
		pjsua2JNI.Endpoint_utilLogWrite__SWIG_0(swigCPtr, this, prmLevel,
				prmSender, prmMsg);
	}

	public void utilLogWrite(LogEntry e) {
		pjsua2JNI.Endpoint_utilLogWrite__SWIG_1(swigCPtr, this,
				LogEntry.getCPtr(e), e);
	}
	...
	public SWIGTYPE_p_void utilTimerSchedule(long prmMsecDelay,
			SWIGTYPE_p_void prmUserData) throws Exception {
		long cPtr = pjsua2JNI.Endpoint_utilTimerSchedule(swigCPtr, this,
				prmMsecDelay, SWIGTYPE_p_void.getCPtr(prmUserData));
		return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, false);
	}

	public void utilTimerCancel(SWIGTYPE_p_void prmToken) {
		pjsua2JNI.Endpoint_utilTimerCancel(swigCPtr, this,
				SWIGTYPE_p_void.getCPtr(prmToken));
	}

	public void utilAddPendingJob(PendingJob job) {
		pjsua2JNI.Endpoint_utilAddPendingJob(swigCPtr, this,
				PendingJob.getCPtr(job), job);
	}

	public IntVector utilSslGetAvailableCiphers() throws Exception {
		return new IntVector(pjsua2JNI.Endpoint_utilSslGetAvailableCiphers(
				swigCPtr, this), true);
	}
	...
	public pj_stun_nat_type natGetType() throws Exception {
		return pj_stun_nat_type.swigToEnum(pjsua2JNI.Endpoint_natGetType(
				swigCPtr, this));
	}

	public void natUpdateStunServers(StringVector prmServers, boolean prmWait)
			throws Exception {
		pjsua2JNI.Endpoint_natUpdateStunServers(swigCPtr, this,
				StringVector.getCPtr(prmServers), prmServers, prmWait);
	}

	public void natCheckStunServers(StringVector prmServers, boolean prmWait,
			SWIGTYPE_p_void prmUserData) throws Exception {
		pjsua2JNI.Endpoint_natCheckStunServers(swigCPtr, this,
				StringVector.getCPtr(prmServers), prmServers, prmWait,
				SWIGTYPE_p_void.getCPtr(prmUserData));
	}

	public void natCancelCheckStunServers(SWIGTYPE_p_void token,
			boolean notify_cb) throws Exception {
		pjsua2JNI.Endpoint_natCancelCheckStunServers__SWIG_0(swigCPtr, this,
				SWIGTYPE_p_void.getCPtr(token), notify_cb);
	}

	public void natCancelCheckStunServers(SWIGTYPE_p_void token)
			throws Exception {
		pjsua2JNI.Endpoint_natCancelCheckStunServers__SWIG_1(swigCPtr, this,
				SWIGTYPE_p_void.getCPtr(token));
	}

	public int transportCreate(pjsip_transport_type_e type, TransportConfig cfg)
			throws Exception {
		return pjsua2JNI.Endpoint_transportCreate(swigCPtr, this,
				type.swigValue(), TransportConfig.getCPtr(cfg), cfg);
	}

	public IntVector transportEnum() throws Exception {
		return new IntVector(pjsua2JNI.Endpoint_transportEnum(swigCPtr, this),
				true);
	}

	public TransportInfo transportGetInfo(int id) throws Exception {
		return new TransportInfo(pjsua2JNI.Endpoint_transportGetInfo(swigCPtr,
				this, id), true);
	}
	...
	public void mediaAdd(AudioMedia media) {
		pjsua2JNI.Endpoint_mediaAdd(swigCPtr, this, AudioMedia.getCPtr(media),
				media);
	}

	public void mediaRemove(AudioMedia media) {
		pjsua2JNI.Endpoint_mediaRemove(swigCPtr, this,
				AudioMedia.getCPtr(media), media);
	}

	public boolean mediaExists(AudioMedia media) {
		return pjsua2JNI.Endpoint_mediaExists(swigCPtr, this,
				AudioMedia.getCPtr(media), media);
	}
	...
	public AudioMediaVector mediaEnumPorts() throws Exception {
		return new AudioMediaVector(pjsua2JNI.Endpoint_mediaEnumPorts(swigCPtr,
				this), false);
	}

	public AudDevManager audDevManager() {
		return new AudDevManager(pjsua2JNI.Endpoint_audDevManager(swigCPtr,
				this), false);
	}

	public VidDevManager vidDevManager() {
		return new VidDevManager(pjsua2JNI.Endpoint_vidDevManager(swigCPtr,
				this), false);
	}

	public CodecInfoVector codecEnum() throws Exception {
		return new CodecInfoVector(
				pjsua2JNI.Endpoint_codecEnum(swigCPtr, this), false);
	}

	public void codecSetPriority(String codec_id, short priority)
			throws Exception {
		pjsua2JNI.Endpoint_codecSetPriority(swigCPtr, this, codec_id, priority);
	}

	public SWIGTYPE_p_void codecGetParam(String codec_id)
			throws Exception {
		long cPtr = pjsua2JNI.Endpoint_codecGetParam(swigCPtr, this, codec_id);
		return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, false);
	}

	public void codecSetParam(String codec_id, SWIGTYPE_p_void param)
			throws Exception {
		pjsua2JNI.Endpoint_codecSetParam(swigCPtr, this, codec_id,
				SWIGTYPE_p_void.getCPtr(param));
	}

	public CodecInfoVector videoCodecEnum() throws Exception {
		return new CodecInfoVector(pjsua2JNI.Endpoint_videoCodecEnum(swigCPtr,
				this), false);
	}

	public void videoCodecSetPriority(String codec_id, short priority)
			throws Exception {
		pjsua2JNI.Endpoint_videoCodecSetPriority(swigCPtr, this, codec_id,
				priority);
	}

	public VidCodecParam getVideoCodecParam(String codec_id)
			throws Exception {
		return new VidCodecParam(pjsua2JNI.Endpoint_getVideoCodecParam(
				swigCPtr, this, codec_id), true);
	}

	public void setVideoCodecParam(String codec_id, VidCodecParam param)
			throws Exception {
		pjsua2JNI.Endpoint_setVideoCodecParam(swigCPtr, this, codec_id,
				VidCodecParam.getCPtr(param), param);
	}
	...
	public void onNatDetectionComplete(OnNatDetectionCompleteParam prm) {
		if (getClass() == Endpoint.class)
			pjsua2JNI.Endpoint_onNatDetectionComplete(swigCPtr, this,
					OnNatDetectionCompleteParam.getCPtr(prm), prm);
		else
			pjsua2JNI.Endpoint_onNatDetectionCompleteSwigExplicitEndpoint(
					swigCPtr, this, OnNatDetectionCompleteParam.getCPtr(prm),
					prm);
	}

	public void onNatCheckStunServersComplete(
			OnNatCheckStunServersCompleteParam prm) {
		if (getClass() == Endpoint.class)
			pjsua2JNI.Endpoint_onNatCheckStunServersComplete(swigCPtr, this,
					OnNatCheckStunServersCompleteParam.getCPtr(prm), prm);
		else
			pjsua2JNI
					.Endpoint_onNatCheckStunServersCompleteSwigExplicitEndpoint(
							swigCPtr, this,
							OnNatCheckStunServersCompleteParam.getCPtr(prm),
							prm);
	}

	public void onTransportState(OnTransportStateParam prm) {
		if (getClass() == Endpoint.class)
			pjsua2JNI.Endpoint_onTransportState(swigCPtr, this,
					OnTransportStateParam.getCPtr(prm), prm);
		else
			pjsua2JNI.Endpoint_onTransportStateSwigExplicitEndpoint(swigCPtr,
					this, OnTransportStateParam.getCPtr(prm), prm);
	}

	public void onTimer(OnTimerParam prm) {
		if (getClass() == Endpoint.class)
			pjsua2JNI.Endpoint_onTimer(swigCPtr, this,
					OnTimerParam.getCPtr(prm), prm);
		else
			pjsua2JNI.Endpoint_onTimerSwigExplicitEndpoint(swigCPtr, this,
					OnTimerParam.getCPtr(prm), prm);
	}

	public void onSelectAccount(OnSelectAccountParam prm) {
		if (getClass() == Endpoint.class)
			pjsua2JNI.Endpoint_onSelectAccount(swigCPtr, this,
					OnSelectAccountParam.getCPtr(prm), prm);
		else
			pjsua2JNI.Endpoint_onSelectAccountSwigExplicitEndpoint(swigCPtr,
					this, OnSelectAccountParam.getCPtr(prm), prm);
	}
