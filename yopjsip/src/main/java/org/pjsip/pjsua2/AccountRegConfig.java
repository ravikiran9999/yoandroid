...
public class AccountRegConfig extends PersistentObject {
	...
	public void setHeaders(SipHeaderVector value) {
		pjsua2JNI.AccountRegConfig_headers_set(swigCPtr, this,
				SipHeaderVector.getCPtr(value), value);
	}
	...
	public void setFirstRetryIntervalSec(long value) {
		pjsua2JNI.AccountRegConfig_firstRetryIntervalSec_set(swigCPtr, this,
				value);
	}

	public long getFirstRetryIntervalSec() {
		return pjsua2JNI.AccountRegConfig_firstRetryIntervalSec_get(swigCPtr,
				this);
	}

	public void setRandomRetryIntervalSec(long value) {
		pjsua2JNI.AccountRegConfig_randomRetryIntervalSec_set(swigCPtr, this,
				value);
	}

	public long getRandomRetryIntervalSec() {
		return pjsua2JNI.AccountRegConfig_randomRetryIntervalSec_get(swigCPtr,
				this);
	}

	public void setDelayBeforeRefreshSec(long value) {
		pjsua2JNI.AccountRegConfig_delayBeforeRefreshSec_set(swigCPtr, this,
				value);
	}

	public long getDelayBeforeRefreshSec() {
		return pjsua2JNI.AccountRegConfig_delayBeforeRefreshSec_get(swigCPtr,
				this);
	}
	...
	public void readObject(ContainerNode node) throws Exception {
		pjsua2JNI.AccountRegConfig_readObject(swigCPtr, this,
