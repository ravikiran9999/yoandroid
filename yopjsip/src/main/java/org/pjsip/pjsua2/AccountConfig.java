...
public class AccountConfig extends PersistentObject {
	...
	public void setRegConfig(AccountRegConfig value) {
		pjsua2JNI.AccountConfig_regConfig_set(swigCPtr, this,
				AccountRegConfig.getCPtr(value), value);
	}
	...
	public void setSipConfig(AccountSipConfig value) {
		pjsua2JNI.AccountConfig_sipConfig_set(swigCPtr, this,
				AccountSipConfig.getCPtr(value), value);
	}
	...
	public void setCallConfig(AccountCallConfig value) {
		pjsua2JNI.AccountConfig_callConfig_set(swigCPtr, this,
				AccountCallConfig.getCPtr(value), value);
	}
	...
	public void setPresConfig(AccountPresConfig value) {
		pjsua2JNI.AccountConfig_presConfig_set(swigCPtr, this,
				AccountPresConfig.getCPtr(value), value);
	}
	...
	public void setMwiConfig(AccountMwiConfig value) {
		pjsua2JNI.AccountConfig_mwiConfig_set(swigCPtr, this,
				AccountMwiConfig.getCPtr(value), value);
	}
	...
	public void setNatConfig(AccountNatConfig value) {
		pjsua2JNI.AccountConfig_natConfig_set(swigCPtr, this,
				AccountNatConfig.getCPtr(value), value);
	}
	...
	public void setMediaConfig(AccountMediaConfig value) {
		pjsua2JNI.AccountConfig_mediaConfig_set(swigCPtr, this,
				AccountMediaConfig.getCPtr(value), value);
	}
	...
	public void setVideoConfig(AccountVideoConfig value) {
		pjsua2JNI.AccountConfig_videoConfig_set(swigCPtr, this,
				AccountVideoConfig.getCPtr(value), value);
	}
	...
	public void readObject(ContainerNode node) throws Exception {
		pjsua2JNI.AccountConfig_readObject(swigCPtr, this,
				ContainerNode.getCPtr(node), node);
	}

	public void writeObject(ContainerNode node) throws Exception {
		pjsua2JNI.AccountConfig_writeObject(swigCPtr, this,
				ContainerNode.getCPtr(node), node);
	}
