...
public class pjsua2JNI {
  ...
  public static void SwigDirector_Call_onCreateMediaTransportSrtp(Call self, long prm) {
    self.onCreateMediaTransportSrtp(new OnCreateMediaTransportSrtpParam(prm, false));
  }
  ...
  public static void SwigDirector_Endpoint_onIpChangeProgress(Endpoint self, long prm) {
    self.onIpChangeProgress(new OnIpChangeProgressParam(prm, false));
  }
